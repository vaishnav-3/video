...
def create_summary(filename, regions):
    ...
    # Return the concatenated videoclip
...
def summarize(srt_file, summarizer, n_sentences, language, bonusWords, stigmaWords):
    ...
    summarizedSubtitles = []
    print()
    # Now the document passed is summarized and we can access the filtered sentences along with the no of sentence
...
def find_summary_regions(srt_filename, summarizer, duration, language, bonusWords, stigmaWords):
    ...
    # Return the resultant summarized subtitle array
    return summary
